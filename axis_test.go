...
func TestAxis(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			optionFactory: func(p *Painter) axisOption {
				...
				return opt.prep(nil).toAxisOption(newTestRangeForLabels(dayLabels, fs))
			},
		...
		},
		{
			...
			optionFactory: func(p *Painter) axisOption {
				return axisOption{
					aRange:        newTestRangeForLabels(dayLabels, fs),
					splitLineShow: true,
				}
			},
		...
		},
		{
			...
			optionFactory: func(p *Painter) axisOption {
				...
				return opt.prep(nil).toAxisOption(newTestRangeForLabels(dayLabels, FontStyle{}))
			},
		...
		},
		{
			...
			optionFactory: func(p *Painter) axisOption {
				return axisOption{
					aRange:        newTestRangeForLabels(dayLabels, FontStyle{}),
					position:      PositionLeft,
					boundaryGap:   Ptr(false),
					splitLineShow: true,
				}
		...
		},
		{
			...
			optionFactory: func(p *Painter) axisOption {
				aRange := newTestRangeForLabels(letterLabels, fs)
		...
		},
		{
			...
			optionFactory: func(p *Painter) axisOption {
				return axisOption{
					aRange:      newTestRangeForLabels(letterLabels, FontStyle{}),
					boundaryGap: Ptr(false),
				}
			},
	...
	for i, tt := range tests {
		t.Run(strconv.Itoa(i)+"-"+tt.name, func(t *testing.T) {
			...
			_, err := newAxisPainter(p, tt.optionFactory(p)).Render()
