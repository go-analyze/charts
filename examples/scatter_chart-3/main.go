...
func writeFile(buf []byte) error {
	...
	file := filepath.Join(tmpPath, "scatter-chart-3.png")
...
func main() {
	...
	opt := charts.ScatterChartOption{
		SeriesList: charts.NewSeriesListScatterMultiValue(values, charts.ScatterSeriesOption{
			MarkLine: charts.NewMarkLine(charts.SeriesMarkTypeMax),
